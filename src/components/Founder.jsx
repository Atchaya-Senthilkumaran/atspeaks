...
export default function FounderSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className={`w-full py-8 sm:py-12 md:py-16 lg:py-20 overflow-x-hidden scroll-reveal ${isRevealed ? 'revealed' : ''}`}
    >
      <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 animate-fade-in">Founder</h2>
      ...
      <div className="bg-white shadow-xl rounded-xl sm:rounded-2xl lg:rounded-3xl p-4 sm:p-5 md:p-6 lg:p-8 xl:p-10 flex flex-col lg:flex-row gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:gap-10 border border-gray-100 relative overflow-hidden w-full hover-lift transition-all duration-300 animate-scale-in">
        <div className="absolute inset-0 bg-gradient-to-r from-[#1f3492]/20 via-[#c8348f]/20 to-[#1f3492]/20 opacity-30 blur-3xl -z-10 animate-pulse-slow"></div>
        ...
        <div className="flex flex-col items-center lg:items-start gap-3 sm:gap-4 md:gap-5">
          <div className="relative w-full flex justify-center lg:justify-start">
            ...
            <img
              src="/atpic.jpg"
              alt="Founder"
              className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 xl:w-52 xl:h-52 object-cover rounded-xl sm:rounded-2xl shadow-xl border border-white/40 hover:scale-105 transition duration-300 max-w-full animate-scale-in"
            />
          </div>

          <div className="grid grid-cols-3 gap-2 sm:gap-2.5 md:gap-3 lg:gap-4 text-center w-full mt-2 sm:mt-3 md:mt-4">
            <div className="p-2 sm:p-2.5 md:p-3 bg-gray-50 rounded-lg sm:rounded-xl shadow-sm hover:scale-105 transition-transform duration-300 animate-fade-in animate-delay-100">
            ...
            <div className="p-2 sm:p-2.5 md:p-3 bg-gray-50 rounded-lg sm:rounded-xl shadow-sm hover:scale-105 transition-transform duration-300 animate-fade-in animate-delay-200">
            ...
            <div className="p-2 sm:p-2.5 md:p-3 bg-gray-50 rounded-lg sm:rounded-xl shadow-sm hover:scale-105 transition-transform duration-300 animate-fade-in animate-delay-300">
        ...
        <div className="flex-1 animate-slide-in-right">
          ...
          <div className="flex gap-2 sm:gap-2.5 md:gap-3 items-center justify-center lg:justify-start">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-2 sm:p-2.5 md:p-3 bg-gray-100 hover:bg-gray-200 rounded-full shadow-sm transition-all duration-300 flex items-center justify-center min-w-[44px] min-h-[44px] hover:scale-110 hover:shadow-md"
            >
