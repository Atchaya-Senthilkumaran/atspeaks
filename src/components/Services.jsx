...
export default function Services() {
  ...
  return (
    <section 
      id="services" 
      ref={sectionRef}
      className={`mt-8 sm:mt-12 md:mt-14 lg:mt-16 w-full overflow-x-hidden scroll-reveal-3d ${isRevealed ? 'revealed' : ''}`}
    >
      <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold flex flex-wrap items-center gap-2 sm:gap-3 animate-3d-pop">
        Services & Courses
