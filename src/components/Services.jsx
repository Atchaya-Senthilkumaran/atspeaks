...
export default function Services() {
  return (
    <section id="services" className="mt-8 sm:mt-12 md:mt-14 lg:mt-16 w-full overflow-x-hidden">
      <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold flex flex-wrap items-center gap-2 sm:gap-3">
        Services & Courses
        <span className="text-[10px] sm:text-xs md:text-sm px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-[#1f3492]/10 text-[#1f3492] font-medium">
          Coming Soon
        </span>
      </h2>
      ...
      <div className="mt-4 sm:mt-6 md:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 w-full">
        ...
        {/* BOOTCAMPS */}
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-gradient-to-br from-[#1f3492]/10 to-white shadow-sm border hover:shadow-md hover:-translate-y-1 transition">
          <Layers className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-[#1f3492] mb-2 sm:mb-3" />
        ...
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-gradient-to-br from-[#1f3492]/10 to-white shadow-sm border hover:shadow-md hover:-translate-y-1 transition">
          <Award className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-[#1f3492] mb-2 sm:mb-3" />
        ...
        {/* PLACEMENT GUIDANCE */}
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-gradient-to-br from-[#1f3492]/10 to-white shadow-sm border hover:shadow-md hover:-translate-y-1 transition">
          <Briefcase className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-[#1f3492] mb-2 sm:mb-3" />
        ...
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-gradient-to-br from-[#1f3492]/10 to-white shadow-sm border hover:shadow-md hover:-translate-y-1 transition">
          <UserCheck className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-[#1f3492] mb-2 sm:mb-3" />
