  ...
  return (
    ...
    >
      ...
      <div className="mt-4 sm:mt-6 md:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 w-full">
        {/* BOOTCAMPS */}
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-gradient-to-br from-[#1f3492]/10 to-white shadow-sm border hover:shadow-2xl hover:-translate-y-3 hover-3d-tilt transition-all duration-500 animate-3d-rotate-y animate-delay-100 perspective-3d flex flex-col">
        ...
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-gradient-to-br from-[#1f3492]/10 to-white shadow-sm border hover:shadow-2xl hover:-translate-y-3 hover-3d-tilt transition-all duration-500 animate-3d-rotate-y animate-delay-200 perspective-3d flex flex-col">
          ...
          <a
            href="/ai-excellence"
            className="mt-4 inline-flex w-fit items-center justify-center rounded-full bg-gradient-to-r from-[#1f3492] to-[#c8348f] px-4 py-2 text-xs sm:text-sm font-semibold text-white shadow-md hover:brightness-110 hover:scale-105 transition-all duration-300"
          >
            Explore Now
          </a>
        </div>
        ...
        {/* PLACEMENT GUIDANCE */}
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-gradient-to-br from-[#1f3492]/10 to-white shadow-sm border hover:shadow-2xl hover:-translate-y-3 hover-3d-tilt transition-all duration-500 animate-3d-rotate-y animate-delay-300 perspective-3d flex flex-col">
        ...
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-gradient-to-br from-[#1f3492]/10 to-white shadow-sm border hover:shadow-2xl hover:-translate-y-3 hover-3d-tilt transition-all duration-500 animate-3d-rotate-y animate-delay-400 perspective-3d flex flex-col">
