...
export default function Community() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 sm:mt-5 md:mt-6 p-4 sm:p-5 md:p-6 lg:p-8 rounded-lg bg-gradient-to-br from-[#1f3492]/10 via-[#1f3492]/5 to-[#c8348f]/10 border-2 border-[#1f3492]/20 shadow-xl relative overflow-visible w-full hover-3d-tilt transition-all duration-500 perspective-3d animate-slide-up-rotate">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4 md:gap-6 w-full z-10">
          <div className="flex items-start gap-2 sm:gap-3 md:gap-4 w-full md:w-auto">
            ...
            <div className="flex-1">
              <h3 className="text-base sm:text-lg md:text-xl font-bold mb-1 sm:mb-2 break-words section-title">
